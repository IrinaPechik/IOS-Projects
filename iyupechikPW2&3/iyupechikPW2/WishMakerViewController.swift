...
//        NSLayoutConstraint.activate(addWishButtonVerticalConstraints)
//    }
...
//        addWishButtonVerticalConstraints = [
//            addWishButton.centerXAnchor.constraint(equalTo: view.centerXAnchor),
//            addWishButton.bottomAnchor.constraint(equalTo: buttonsStack.topAnchor, constant: -10),
//            addWishButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: Constants.stackLeading)]
//
//        addWishButtonHorizontalConstraints = [
//            addWishButton.trailingAnchor.constraint(equalTo: buttonsStack.trailingAnchor),
//            addWishButton.bottomAnchor.constraint(equalTo: buttonsStack.topAnchor, constant: -10),
//            addWishButton.centerXAnchor.constraint(equalTo: buttonsStack.centerXAnchor)]
    }
